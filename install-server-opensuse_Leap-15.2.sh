...
zypper install vim mc gpm rsync sudo compsize docker docker-compose net-tools tree ncdu moreutils openvpn tcpdump lynx links elinks curl net-tools-deprecated iotop rclone mosh
