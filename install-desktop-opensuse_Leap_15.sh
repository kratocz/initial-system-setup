...
test -e "$REPOD/network_im_signal.repo" || zypper addrepo "https://download.opensuse.org/repositories/network:im:signal/openSUSE_Leap_$VERSION/network:im:signal.repo" # package signal-desktop
